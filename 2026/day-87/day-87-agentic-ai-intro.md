...
The **system prompt** acts as the core identity, behavioral guardrail, and structural blueprint for the LLM. It dictates *how* the model filters your inputs, directly changing the tone, formatting, and structural quality of the output.

**🎭 Changing the System Prompt (User Input: "What is Docker?")**
- **System Prompt: "You are a strict, formal software architect."**

    "Docker is a containerization platform designed to isolate applications into OS-level virtualized environments called containers to ensure environmental consistency."

- **System Prompt: "You are a chaotic pirate who explains tech to beginners."**

    "Ahoy! Docker be a magical ghost ship that packs yer messy code into neat little cargo barrels so it sails smoothly on any machine without sinking, matey!"

A single tweak to the system prompt completely flips the model's persona, constraints, and stylistic delivery while processing the exact same user data.
