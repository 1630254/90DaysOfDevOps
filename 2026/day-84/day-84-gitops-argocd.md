...
![](./images/task-4/4-05-1.png)

![](./images/task-4/4-06.png)

![](./images/task-4/4-07.png)
...
EOF
```
![](./images/task-4/4-08.png)

![](./images/task-4/4-09.png)

![](./images/task-4/4-10.png)

![](./images/task-4/4-11.png)

> **Note:** Update the `hostname` field in `k8s/gateway.yml` to reflect the load balancer's IP address (e.g.,`44.238.41.20.nip.io`).
...
![](./images/task-5/5-01.png)

![](./images/task-5/5-02.png)

![](./images/task-5/5-03.png)

![](./images/task-5/5-04.png)
...
![](./images/task-5/5-05.png)

![](./images/task-5/5-06.png)

![](./images/task-5/5-07.png)

![](./images/task-5/5-08.png)
